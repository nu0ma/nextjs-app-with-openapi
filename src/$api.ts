...
// prettier-ignore
import { Methods as Methods0 } from './api/comments'
// prettier-ignore
import { Methods as Methods1 } from './api/posts'
// prettier-ignore
import { Methods as Methods2 } from './api/posts/_id@string'
        ...
        _id: (val2: string) => {
          ...
          return {
            ...
            patch: (option: { body: Methods2['patch']['reqBody'], config?: T }) =>
              fetch<Methods2['patch']['resBody'], BasicHeaders, Methods2['patch']['status']>(prefix, prefix2, PATCH, option).json(),
            /**
             * @returns OK
             */
            $patch: (option: { body: Methods2['patch']['reqBody'], config?: T }) =>
              fetch<Methods2['patch']['resBody'], BasicHeaders, Methods2['patch']['status']>(prefix, prefix2, PATCH, option).json().then(r => r.body),
            /**
             * @returns OK
             */
